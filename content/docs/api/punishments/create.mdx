...
| `issuerName` | string | No | The name of the staff member issuing the punishment. |
| `issuerId` | string | No | The unique identifier of the staff member issuing the punishment. |
| `type_ordinal` | integer | Yes | The punishment type ordinal (min: 0). |
