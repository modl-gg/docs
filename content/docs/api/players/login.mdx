...
| `ipInfo` | object | No | IP geolocation information (e.g., country, region, ASN). |
| `skinHash` | string | No | The hash of the player's current skin. |
| `serverName` | string | No | The name of the server the player is joining. |
